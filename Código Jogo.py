...
numero2 = str(random.randint(0, 9))
numero3 = str(random.randint(0, 9))
...
N1 = random.choice([numero1, letra1])
N2 = random.choice([numero2, letra2])
N3 = random.choice([numero3, letra3])
